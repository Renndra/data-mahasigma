...
.preloader .loading {
    font: bold 1.2em 'Righteous', sans-serif;
    color: #007bff;
}
...
<body>
    ...
    <div class="preloader">
    <div class="loading">
    <img src="img/loading-gif.gif" width="80">
    <p>Harap Tunggu...</p>
  </div>
</div>
    <!-- Navbar -->
    ...
    <div class="container">
        <div class="row my-2">
            <div class="card p-4 mb-3">
                <h3 class="card-title">Data Mahasigma <img src="img/blue emoji.jpeg" alt="sigma" style="width: 100px;"></h3>
                <hr>
            </div>
        </div>
        <div class="row my-2">
